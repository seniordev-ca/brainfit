  ...
  if (show) {
    return (
      <div className={[
        ...
        "overflow-hidden flex flex-col items-center justify-center z-50 loader",
        wrapperClass
      ].join(' ')}>
        {
          props.children ?
            props.children :
            <svg role="status" className="mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
