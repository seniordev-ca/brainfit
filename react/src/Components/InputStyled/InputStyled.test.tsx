...
test('renders Input', () => {
  render(
    <Provider store={store}>
      <InputStyled id="inputTest" label="label" />
    </Provider>
  );
...
test('renders Input with error text', () => {
  render(
    <Provider store={store}>
      <InputStyled id="inputTest" label="label" errorText="Please enter a value" />
    </Provider>
  );
...
test('render Input with hint', () => {
  render(
    <Provider store={store}>
      <InputStyled id="inputTest" label="label" hint='hint' />
    </Provider>
  );
...
test('render Input with static/prefilled value', () => {
  render(
    <Provider store={store}>
      <InputStyled id="inputTest" label="label" value="Tokyo" />
    </Provider>
  );
  const { data }: DataState = store.getState().data;
  expect(data.inputTest).toEqual('Tokyo');
